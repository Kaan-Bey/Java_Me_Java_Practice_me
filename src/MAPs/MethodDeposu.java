...
public class MethodDeposu {
    ...
    public static void isimSoyisimIleOgrenciBul(Map<Integer, String> ogrenciMap, String isim, String soyIsim) {
        ...
        for (String eachValue : valueCollection
            ...
            String sinifStr = isim + "";
            if (valueArr[0].equals(isim) && valueArr[1].equalsIgnoreCase(soyIsim)) {
        ...
        /*
        public static void ogrenciNoIleOgrenciListe (Map < Integer, String > ogrenciMap,int ogrenciNo){
            ...
            String sinifStr = isim + "";
            if (istenenOgrenciArr[0].equals(isim) && istenenOgrenciArr[1].equalsIgnoreCase(soyIsim)) {
                System.out.println("Isim : " + istenenOgrenciArr[0] +
                                "Soyisim : " + "," + istenenOgrenciArr[1]
                        "Sube : " + "," + istenenOgrenciArr[2] +
                                "Sinif :" + "," + istenenOgrenciArr[3]);
            }
